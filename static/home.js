...
$(document).ready(function () {
    ...
    function keyboardCursor() {
        const containers = $('.element-start-up-page-dark .frame-wrapper');
        let currentIndex = 0;
        ...
        function handleEnterKey(index) {
            if (!isHandlingEnterKey) {
                ...
                window.location.href = 'http://127.0.0.1:5000/charts?selectedContainer=' + index;
        ...
        function handleBackKey(index) {
          if (!isHandlingBackKey) {
              ...
              // Change the window location to the charts page with the selected index as a parameter
              window.location.href = 'http://127.0.0.1:5000/overlay';
        ...
        $(document).on('keydown', e => {
            ...
            {
                containers.eq(currentIndex).removeClass('hovered active');
